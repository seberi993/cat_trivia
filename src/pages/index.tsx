...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className=" display:flex bg-gray-600 min-h-screen">
        ...
        <div>
          {inputVisibility ? (
            <div>
              <h3 className="font-bold text-center text-xl text-gray-900"> {question}</h3>
              <div>
          ...
          {inputVisibility ? (
            <div className="static">
              <input
                className="rounded-full absolute bottom-20 right-20 left-20 bg-gray-50 p-2.5 dark:bg-gray-700 dark:text-white"
                type="text"
                id="fname"
                name="fname"
              ></input>
              <button
                className=" absolute right-0 bottom-0 right-80 left-80 rounded-full bg-blue-400 py-2 px-4 font-bold text-white hover:bg-blue-700"
                onClick={answerHandler}
              >
                Submit
              </button>{" "}
              <button
                className=" absolute left-0 top-80 rounded-full bg-blue-400 py-2 px-4 font-bold text-white hover:bg-blue-700"
                onClick={showHint}
              >
                Get Hint
              </button>
          ...
          <div className="myBody">
            ...
            {isWinning ? (
              <div>
                <button
                  className="absolute w-full h-full rounded-full bg-blue-400 py-2 px-4 font-bold text-white hover:bg-blue-700"
                  onClick={showCat}
                >
                  SHOW CAT
                </button>
              ...
              <div>
                <button
                  className="absolute top-80 right-0 rounded-full bg-blue-400 py-2 px-4 font-bold text-white hover:bg-blue-700"
